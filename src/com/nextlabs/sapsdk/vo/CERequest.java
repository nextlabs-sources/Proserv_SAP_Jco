...
public class CERequest implements Serializable {
	...
	public CERequest(String action, CEResource source,
			CEAttributes sourceAttrs, CEResource dest, CEAttributes destAttrs,
			CEUser user, CEAttributes userAttrs, CEApplication app,
			CEAttributes appAttrs, String[] recipients,
			CENamedAttributes[] additionalAttrs, boolean performObligations,
			int noiseLevel) {
		this.action = action;
		this.source = source;
	...
	public boolean equals(Object arg) {
		...
		return (this.action.equals(that.action)
				...
				&& attrsEqual(this.sourceAttrs, that.sourceAttrs)
				&& ((this.dest == null && that.dest == null) || (this.dest != null
						&& that.dest != null && this.dest.equals(that.dest) && attrsEqual(
							this.destAttrs, that.destAttrs)))
				&& this.user.equals(that.user)
				&& attrsEqual(this.userAttrs, that.userAttrs)
				&& this.user.equals(that.user)
				&& attrsEqual(this.userAttrs, that.userAttrs)
				&& this.app.equals(that.app)
				&& attrsEqual(this.appAttrs, that.appAttrs)
				&& Arrays.equals(this.recipients, that.recipients)
				&& Arrays.equals(this.additionalAttrs, that.additionalAttrs)
				&& (this.performObligations == that.performObligations) && (this.noiseLevel == that.noiseLevel));
	...
	public int hashCode() {
		...
		result = prime * result
				+ (sourceAttrs == null ? 0 : sourceAttrs.hashCode());
		result = prime * result + (dest == null ? 0 : dest.hashCode());
		result = prime * result
				+ (destAttrs == null ? 0 : destAttrs.hashCode());
		result = prime * result + (user == null ? 0 : user.hashCode());
		result = prime * result
				+ (userAttrs == null ? 0 : userAttrs.hashCode());
		result = prime * result + (app == null ? 0 : app.hashCode());
		result = prime * result + (appAttrs == null ? 0 : appAttrs.hashCode());
		result = prime * result
				+ (recipients == null ? 0 : recipients.hashCode());
		result = prime * result
				+ (additionalAttrs == null ? 0 : additionalAttrs.hashCode());
