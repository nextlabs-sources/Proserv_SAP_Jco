...
public class CEApplication implements Serializable {
	 ...
	 * 
	 * @param name
	 *            the application name (e.g. "iexplore.exe")
	 * @param path
	 *            the path (e.g. "c:/windows/system32/iexplore.exe")
	 */
	...
	public boolean equals(Object arg) {
		if (this == arg)
			return true;
		if (!(arg instanceof CEApplication))
			return false;
		CEApplication that = (CEApplication) arg;
		return (this.name.equals(that.name) && this.path.equals(that.path) && this.url
				.equals(that.url));
	}
