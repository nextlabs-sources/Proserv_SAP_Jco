...
public class CEEnforcement implements Serializable {
	...
	public enum CEResponse {
		ALLOW("allow", 0), DENY("deny", 1), DONTCARE("dontcare", 2);
	 ...
	 * 
	 * @param response
	 *            the response as a string ("allow", "deny", "dontcare")
	 * @param obligations
	 *            the obligations
	 */
	 ...
	 * 
	 * @param response
	 *            the response as a sring ("allow", "deny", or "dontcare")
	 */
	...
	public boolean equals(Object arg) {
		if (this == arg)
			return true;
		if (!(arg instanceof CEEnforcement))
			return false;
		CEEnforcement that = (CEEnforcement) arg;
		return (this.response == that.response && this.obligations
				.equals(that.obligations));
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((obligations.size() > 0) ? 0 : obligations.hashCode());
		return result;
	}
